...
public class FormPageElem {
    public final static By ACC_ID_LABEL_FORM = MobileBy.AccessibilityId("Forms");
    ...
    public final static By XPATH_DROPDOWN_ITEM = MobileBy.AccessibilityId("//android.view.ViewGroup" +
